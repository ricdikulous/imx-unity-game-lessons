...
Welcome to Lesson 08, where we focus on the dynamic upload of metadata, a core feature in creating unique NFTs for our players. In our 'Trash Dash' game, players can earn randomized NFT rewards. This tutorial sets up the core dynamic metadata functionality that we will use later to mint a random NFT.
